					...
					<div class="panel-body">
                        ...
                        <form id="data-all" enctype="multipart/form-data">
                            ...
                            <table id="myTable" class="table table-striped table-bordered table-td-valign-middle">
                                ...
                                <tbody>
                                    @foreach(vendor_get() as $no=>$o)
                                        <tr>
                                            <td style="vertical-align: top !important;">{{$no+1}}</td>
                                            <td style="vertical-align: top !important;">{{$o->kode_vendor}}</td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="col-xl-8 offset-xl-2">
										<legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Profil Vendor</legend>
