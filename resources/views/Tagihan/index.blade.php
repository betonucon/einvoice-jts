            ...
            <div class="col-xl-12 ui-sortable">
                <div class="panel panel-inverse" data-sortable-id="ui-general-1">
					...
					<div class="panel-body">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <button class="btn btn-blue" onclick="tambah()">Buat Baru</button>
                            ...
                            <table id="myTable" class="table table-striped table-bordered table-td-valign-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="14%">Tanggal Tagihan</th>
                                        <th width="13%">Status</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach(tagihan_get() as $no=>$o)
                                        <tr>
...
@push('ajax')
    ...
    <script  type="text/javascript" >
        ...
        function tambah(){
			...
			location.assign("{{url('Tagihan/Create')}}");
		}

        function ubah(a){
			
			location.assign("{{url('Tagihan/Edit')}}?id="+a);
		}
