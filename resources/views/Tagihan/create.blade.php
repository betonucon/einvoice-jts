            ...
            <div class="col-xl-12 ui-sortable">
                <div class="panel panel-inverse" data-sortable-id="ui-general-1">
                    ...
                    <div class="panel-body" style="background: #b5b5d330;">
                        ...
                        <form id="data-tambah" action="{{url('/Tagihan')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="tab-content" style="margin-bottom:0px;padding:1%;background:#fff">
                                <div class="tab-pane fade active show" id="default-tab-1">
                                    <div class="col-xl-10 offset-xl-1">
                                        <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Pengajuan Tagihan</legend>
                                            
                                        <div class="form-group row m-b-10">
                                            <label class="col-lg-3 text-lg-right col-form-label">Pilih Kategori Tagihan</span></label>
                                            <div class="col-lg-9 col-xl-4">
                                                <select name="tagihan" placeholder="ketik disini..." onchange="pilih_tagihan(this.value)" class="form-control">
                                                    <option value="">-- Pilih Tagihan -----</option>
                                                    <option value="1" @if($tagihan==1) selected @endif >- Perbaikan Angkutan</option>
                                                    <option value="2" @if($tagihan==2) selected @endif >- Tagihan Listrik dll</option>
                                                </select>
                                            </div>
                                        </div>
                                        @if($tagihan==1)
                                            <div class="form-group row m-b-10">
                                                ...
                                                <div class="col-lg-9 col-xl-5">
                                                    <input type="text"  name="invoice" placeholder="ketik disini..."  class="form-control">
                                                </div>
                                                <div class="col-lg-9 col-xl-4">
                                                ...
                                                <div class="col-lg-9 col-xl-4">
                                                    <select name="kode_vendor" placeholder="ketik disini..."  class="form-control">
                                                        ...
                                                        @foreach(vendor_get() as $ven)
                                                            <option value="{{$ven->kode_vendor}}">{{$ven->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
...
@push('ajax')
    ...
    <script  type="text/javascript" >
        ...
        function pilih_tagihan(a){
            location.assign("{{url('Tagihan/Create')}}?tagihan="+a);
        }
