        ...
        <div class="divlokasi">
            ...
            <table width="100%" border="0">
                <tr>
                    <td style="text-align:center;padding-top:30px">
                        @if($data->transaksi==1)
                            <font style="font-weight:bold;color:#000;font-size:19px;display:block">MASUK BARANG</font>
                        @else
                            <font style="font-weight:bold;color:#000;font-size:19px;display:block">KELUAR BARANG</font>
                        @endif
                    </td>
                </tr>
            </table><br>
                        ...
                        <table width="100%" border="0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="thth" width="15%">Gudang</th>
                                    <th class="thth">Detail</th>
                                    <th class="thth" width="15%">Qty</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $jum=0;?>
                                @foreach(transaksigudang_get($data->id,$data->transaksi) as $nx=>$detail)
                                <?php $jum+=$detail['qty']; ?>
                                    
                                    <tr>
                                        <td class="tdtd">{{($nx+1)}}</td>
                                        <td class="tdtd">{{$detail->gudang['kode']}}</td>
                                        <td class="tdtd">{{$detail->gudang['name']}}</td>
                                        <td class="tdtd" align="right">{{$detail['qty']}}</td>
                                    </tr>
                                @endforeach
                                <tr>
                                    <td class="tdtd">&nbsp;</td>
                                ...
                                <tr>
                                    <td class="tdtd" colspan="3">Total</td>
                                    <td class="tdtd" align="right">{{$jum}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
