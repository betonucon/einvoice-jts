...
<head>
	...
	<link href="{{url('assets/assets/plugins/gritter/css/jquery.gritter.css')}}" rel="stylesheet">
	<style>
		.loadnya {
			height: 100%;
			width: 0;
...
<body style="background: url({{url('img/bgbg2.jpg')}});background-size: cover;">
	...
	<div id="page-container"  class="fade page-sidebar-fixed page-header-fixed page-with-light-sidebar">
		...
		<div id="header" class="header navbar-inverse">
			...
			<div class="navbar-header">
				<a href="index.html" class="navbar-brand"><img src="{{url('img/pt2.png')}}" alt="" /></a>
		...
		<!-- end #content -->
		<div class="row">
				<div class="modal fade" id="modal-create-sewa" aria-hidden="true" style="display: none;">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<div id="nomorsewa" class="noot"></div>
							</div>
	...
	@if(Auth::user()->role_id==5)
		@if(all_bayar_notif()>0)
			<div id="gritter-notice-wrapper" style="top: 50px;right: 2%;">
				<div id="gritter-item-2" style="background: rgb(141 125 66 / 90%);" class="gritter-item-wrapper my-sticky-class" style="" role="alert">
					<div class="gritter-top"></div>
					<div class="gritter-item">
						<a class="gritter-close" href="#" onclick="tutup_gliter()" style="display: none;">Tutup</a>
						<div class="gritter-with-image">
							<span class="gritter-title">Notifikasi</span>
							<p>Ada <b style="color: yellow;font-size: 14px;">{{all_bayar_notif()}}</b> Tagihan atau Invoice yang harus diproses</p>
						</div>
	...
	@if(Auth::user()->role_id==4)
		@if(all_notif()>0)
			<div id="gritter-notice-wrapper" style="top: 50px;right: 20%;">
				<div id="gritter-item-2" style="background: rgb(141 125 66 / 90%);" class="gritter-item-wrapper my-sticky-class" style="" role="alert">
					<div class="gritter-top"></div>
					<div class="gritter-item">
						...
						<div class="gritter-with-image">
							<span class="gritter-title">Notifikasi</span>
							<p>Ada <b style="color: yellow;font-size: 14px;">{{all_notif()}}</b> Tagihan atau Invoice yang harus dikerjakan</p>
						</div>
						<div style="clear:both"></div>
					</div>
					<div class="gritter-bottom"></div>
	...
	<script src="{{url('assets/assets/plugins/gritter/js/jquery.gritter.js')}}"></script>
	<!-- ================== END BASE JS ================== -->
	...
	<script>
		...
		function tutup_gliter(){
			document.getElementById("gritter-notice-wrapper").style.display = "none";
		}

		function create_sewa(){
			
			$.ajax({
				type: 'GET',
				url: "{{url('Invoice/create_sewa')}}",
				data: "id=1",
				success: function(msg){
					location.assign("{{url('Invoice/Create')}}?invoice="+msg);
					
				}
			}); 
		}

		function create_sewa_angkutan(){
			
			$.ajax({
				type: 'GET',
				url: "{{url('Angkutan/create_sewa')}}",
				data: "id=1",
				success: function(msg){
					location.assign("{{url('Angkutan/Create')}}?invoice="+msg);
