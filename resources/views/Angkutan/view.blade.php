                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form id="data-approval" action="{{url('/Angkutan/Approval')}}" method="post" enctype="multipart/form-data">
                                        @csrf
...
@push('ajax')
    ...
    <script  type="text/javascript" >
        $(document).ready(function() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{url('Angkutan/lokasi_gudang_view')}}",
        ...
        function approval(){
            ...
            var form=document.getElementById('data-approval');
                ...
                $.ajax({
                    ...
                    success: function(msg){
                        if(msg=='ok'){
							location.assign("{{url('AngkutanAcc')}}");
