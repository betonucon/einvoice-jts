            ...
            <div class="col-xl-12 ui-sortable">
                <div class="panel panel-inverse" data-sortable-id="ui-general-1">
                    ...
                    <div class="panel-body" style="background: #b5b5d330;">
                        ...
                        <form id="data-tambah" action="{{url('/Angkutan')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="tab-content" style="margin-bottom:0px;padding:1%;background:#fff">
                                <div class="tab-pane fade active show" id="default-tab-1">
                                    <div class="col-xl-10 offset-xl-1">
                                        <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Pengajuan Angkutan</legend>
                                        <div class="form-group row m-b-10">
                                            <label class="col-lg-3 text-lg-right col-form-label">Angkutan</span></label>
                                            <div class="col-lg-9 col-xl-5">
                                                <input type="text" disabled  name="Angkutan" value="{{$data->invoice}}" placeholder="ketik disini..."  class="form-control">
                                            </div>
                                        ...
                                        <div class="form-group row m-b-10">
                                            <label class="col-lg-3 text-lg-right col-form-label">Keterangan Angkutan</span></label>
                                        ...
                                        <div class="form-group row m-b-10">
                                            <label class="col-lg-3 text-lg-right col-form-label">Tanggal Kontrak</span></label>
                                            <div class="col-lg-9 col-xl-3">
...
@push('ajax')
    ...
    <script  type="text/javascript" >
        ...
        function pilih_transaksi(a){
            if(a==1){
                location.assign("{{url('Angkutan/Create?Angkutan='.$data->Angkutan)}}&transaksi="+a);
            }else{
                location.assign("{{url('Angkutan/Create?Angkutan='.$data->Angkutan)}}&transaksi="+a);
            }
        }
