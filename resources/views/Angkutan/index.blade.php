            ...
            <div class="col-xl-12 ui-sortable">
                <div class="panel panel-inverse" data-sortable-id="ui-general-1">
					...
					<div class="panel-body">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <button class="btn btn-blue" onclick="create_sewa_angkutan()">Buat Baru</button>
                        ...
                        <form id="data-all" enctype="multipart/form-data">
                            ...
                            <table id="myTable" class="table table-striped table-bordered table-td-valign-middle">
                                ...
                                <tbody>
                                    @foreach(invoice_angkutan_get() as $no=>$o)
                                        <tr>
                                            ...
                                            <td style="vertical-align: top !important;">
                                                ...
                                                @else
                                                    @if($o->sts==3)
                                                        <span class="btn btn-aqua btn-xs" onclick="cetak(`{{base64_encode($o->id)}}`)" style="margin-bottom:1%"><i class="fas fa-file-pdf"></i></span>
                                                        <span class="btn btn-green btn-xs" onclick="proses(`{{base64_encode($o->id)}}`)" style="margin-bottom:1%"><i class="fas fa-random"></i></span>
                                                    @else
...
@push('ajax')
    ...
    <script  type="text/javascript" >
        ...
        function tambah(){
			...
			location.assign("{{url('Angkutan/Create')}}");
		}

        function ubah(a){
			
			location.assign("{{url('Angkutan/Edit')}}?id="+a);
		}
        function proses(a){
			
			location.assign("{{url('Angkutan/view_admin')}}?id="+a);
		}
