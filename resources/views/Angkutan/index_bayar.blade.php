					...
					<div class="panel-body">
                        <form id="data-all" enctype="multipart/form-data">
                            ...
                            <table id="myTable" class="table table-striped table-bordered table-td-valign-middle">
                                ...
                                <tbody>
                                    @foreach(invoice_angkutan_bayar_get() as $no=>$o)
                                        <tr>
...
@push('ajax')
    ...
    <script  type="text/javascript" >
        ...
        function approve(a){
            ...
            location.assign("{{url('Angkutan/View')}}?id="+a);
		}

        function buka_invoice(a){
            var file="<iframe src='{{url('Angkutan/Cetak')}}?inv="+a+"' height='550' width='100%'></iframe>";
            $('#modal-file').modal('show');
            $('#tampil-file').html(file);
        }
