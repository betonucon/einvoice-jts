                            ...
                            <table id="myTable" class="table table-striped table-bordered table-td-valign-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="10%" class="text-nowrap">Keadaan</th>
                                        <th width="13%" class="text-nowrap">Riwayat</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach(alat_get() as $no=>$o)
                                        <tr>
                                            ...
                                            <td style="vertical-align: top !important;">
                                                @if($o->sts==1)
                                                    <font style="font-weight:bold;color:blue">Ready</font>
                                                @else
                                                    <font style="font-weight:bold;color:red">Maintenance</font>
                                                @endif
                                            </td>
